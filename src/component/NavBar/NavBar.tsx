...
export const NavBar: FC = () => {
    ...
    const linkArr: string[] = ['Spoiler','Tabs','Random Generator','Time', 'Scroll Button', 'Dropdown Menu', 'Form', 'Modal Window', 'Burger Menu', 'RTK Query','Slider', 'Calculator', 'ToDo', 'Encoder'];
